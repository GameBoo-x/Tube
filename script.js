...
const Game = () => {
  ...
  return /*#__PURE__*/(
    ...
    hand && /*#__PURE__*/React.createElement(Activation, { dark: dark }, "Help activated!"),
    leg && /*#__PURE__*/React.createElement(Activation, { dark: dark }, "Help activated!"), /*#__PURE__*/
    React.createElement(HangZone, null, /*#__PURE__*/
    React.createElement(HangingMan, {
      dark: dark,
      preserveAspectRatio: "xMinYMin",
      viewBox: "0 0 200 200" }, /*#__PURE__*/
    React.createElement(Frame, { d: "M 5 195 L 5 5 L 100 5 M 50 5 L 5 50" }), /*#__PURE__*/
    React.createElement(Swingers, { animate: fails.length > 1 },
    fails.length >= 1 && /*#__PURE__*/React.createElement(Rope, { d: "M 100 5 L 100 30" }),
    fails.length >= 2 && /*#__PURE__*/React.createElement(Head, { cx: "100", cy: "50", r: "20" }),
    fails.length >= 3 && /*#__PURE__*/React.createElement(Body, { d: "M 100 70 L 100 120" }),

    !hand &&
    !leg &&
    fails.length >= 4 && /*#__PURE__*/React.createElement(Arms, { d: "M 90 110 L 100 80 L 110 110" }),
    !hand &&
    !leg &&
    fails.length >= 5 && /*#__PURE__*/React.createElement(Legs, { d: "M 96 140 L 100 120 L 104 140" }),

    hand &&
    !leg &&
    fails.length >= 4 && /*#__PURE__*/React.createElement(Arms, { d: "M 90 110 L 100 80" }),
    hand &&
    !leg &&
    fails.length >= 5 && /*#__PURE__*/React.createElement(Arms, { d: "M 100 80 L 110 110" }),
    hand &&
    !leg &&
    fails.length >= 6 && /*#__PURE__*/React.createElement(Legs, { d: "M 96 140 L 100 120 L 104 140" }),
    ...
    !hand &&
    leg &&
    fails.length >= 5 && /*#__PURE__*/React.createElement(Legs, { d: "M 96 140 L 100 120" }),
    !hand &&
    leg &&
    fails.length >= 6 && /*#__PURE__*/React.createElement(Legs, { d: "M 100 120 L 104 140" }),
    ...
    hand &&
    leg &&
    fails.length >= 6 && /*#__PURE__*/React.createElement(Legs, { d: "M 96 140 L 100 120" }),
    hand &&
    leg &&
    fails.length >= 7 && /*#__PURE__*/React.createElement(Legs, { d: "M 100 120 L 104 140" })))), /*#__PURE__*/
    ...
    (fails.length === threshold.current || successes.length === 6) && /*#__PURE__*/
    React.createElement(Result, { dark: dark, lost: fails.length === 5 }, /*#__PURE__*/
    React.createElement("h1", null, `${successes.length === 6 ? 'Well Done!' : 'Unlucky!'}`), /*#__PURE__*/
    React.createElement(NewGameButton, { dark: dark, onClick: newGame }, "New Game"),


    successes.length === 6 &&
    new Array(15).fill().map((f, i) => /*#__PURE__*/
